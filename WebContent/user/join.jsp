    ...
    <div id="sub_wrap" class="webfont">
        <div id="aside">
            <div class="left_title">
                ...
                <p class="small_title">Join</p>
                <p class="bl_lt">▼</p>
            </div>
            <div class="mid_nav">
                <ul class="mid_menu">
                    <li><a href="<%=request.getContextPath() %>/pet_login.do">
                    	<i class="fa fa-caret-right"></i>로그인</a>
                    </li>
                    <li><a href="<%=request.getContextPath() %>/pet_join.do" class="nav_on">
            ...
            <div class="page_count_bg"> 
                <div id="page_count" class="clearfix">
                    <ul>
                        ...
                        <li> <i class="fa fa-angle-right"></i> <strong>Join</strong></li>
                    </ul>
                </div>
            </div>
