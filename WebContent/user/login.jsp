...
<body>
    ...
    <div id="sub_wrap" class="webfont">
        ...
        <div id="section">
            ...
            <p class="sub_title">로그인 <span class="sub_title2">Login</span></p>
            
            <!-- 본문 시작 -->
            <div id="sub_contents">
                <div id="login_wrap">
                    <form method="post" action="<%=request.getContextPath() %>/pet_login_ok.do">
                        <table class="login_t">
			                <tr>
			                   <th><i class="fa fa-envelope"></i></th>
			                   <td> <input type="text" class="input_box" name="user_id" placeholder="아이디"> </td>
			                </tr>
			                <tr>
			                   <td class="emp"></td>
			                </tr>
