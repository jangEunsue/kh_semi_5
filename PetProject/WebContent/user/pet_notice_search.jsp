...
<body>
    ...
    <div id="sub_wrap" class="webfont">
        ...
        <div id="section">
            ...
            <p class="sub_title">공지사항 검색된 결과<span class="sub_title2">Notice</span></p>
                ...
                <div id="table_wrap">
                    ...
                    <div class="ext_paging" style="margin-top: 20px;">
                        ...
                        <c:if test="${page > block }">
                            <a href="pet_notice_search.do?page=1"> ◀◀ </a>
                            <a href="pet_notice_search.do?page=${startBlock -1 }"> &lt;<span class="page_s">이전</span> | </a>&nbsp;
                        </c:if>
                        
                        <c:forEach begin="${startBlock }" end="${endBlock }" var = "i">
                            <c:if test="${i == page }">
                                <b><a href = "pet_notice_search.do.do?page=${i }">[${i }]</a></b>
                            </c:if>
                            <c:if test="${i != page }">
                                <a href = "pet_notice_search.do?page=${i }">[${i }]</a>
                            </c:if>
                        </c:forEach>
                        
                        <c:if test="${endBlock < allPage }">
                            &nbsp;<a href="pet_notice_search.do?page=${endBlock + 1 }"> | <span class="page_s">다음</span>&gt; </a>
                            <a href="pet_notice_search.do?page=${allPage }"> ▶▶ </a>
                        </c:if>
                    </div>
