        ...
        <div id="navwrap_bg" class="clearfix">
            ...
            <nav id="nav" class="clearfix">
                <ul class="menu">
                    ...
                    <%  }else {  %>
                    		<li><a href="<%=request.getContextPath() %>/pet_modify.do?id=<%=(String)session.getAttribute("sessionID") %>">마이페이지</a>
	                            <ul>
	                            	<li><a href="<%=request.getContextPath() %>/pet_modify.do?id=<%=(String)session.getAttribute("sessionID")%>">회원정보수정</a></li>
