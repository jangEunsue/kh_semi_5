...
<body>
	...
	<div align="center">
		...
		<table>
			<tr>
				<td rowspan="2"><a
					href="<%=request.getContextPath() %>/user_product_view.do?pnum=${dto.getSales_p_no()}">
						<img
		...
		<form method="post"
			action="<%=request.getContextPath()%>/insertReview.do"
			...
			<table>
				...
				<tr>
					<td align="center"><input type="submit" value="작성 완료">
					</td>
				</tr>
			</table>
		</form>
